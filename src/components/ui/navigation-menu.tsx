...
const navigationMenuTriggerStyle = cva(
  "group/navigation-menu-trigger inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium transition-all outline-none hover:bg-slate-200 focus:bg-slate-200 focus-visible:ring-3 focus-visible:ring-ring/50 focus-visible:outline-1 disabled:pointer-events-none disabled:opacity-50 data-popup-open:bg-slate-200/50 data-popup-open:hover:bg-slate-200 data-open:bg-slate-200/50 data-open:hover:bg-slate-200 data-open:focu s:bg-slate-200",
);
